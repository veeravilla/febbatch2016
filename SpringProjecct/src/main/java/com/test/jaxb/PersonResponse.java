...
// Generated on: 2016.03.25 at 07:21:01 PM CDT 
//
...
public class PersonResponse implements Cloneable, CopyTo, Equals, HashCode, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PersonResponse) {
            final PersonResponse copy = ((PersonResponse) draftCopy);
            if (this.person!= null) {
                Person sourcePerson;
